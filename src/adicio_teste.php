<?php
    require "conexao.php";
    if($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['nome'] != "" && $_POST['ca'] != "" && $_POST['unidade'] != ""  && $_POST['estoque'] != ""  && $_POST['minimo'] != ""  && $_POST['validade'] != ""){

        $pdo = new conexao();

        $pdo->adicionar($_POST['nome'],$_POST['ca'],$_POST['unidade'],$_POST['estoque'],$_POST['minimo'],$_POST['validade']);
