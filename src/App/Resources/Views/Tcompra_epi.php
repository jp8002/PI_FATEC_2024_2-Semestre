...
<body>
    ...
    <img src="PI2V2/App/Resources/imagens/atualizarepi.png" alt="erro" width="70" height="70">
        ...
        <div class="input-group mb-3">
          ...
          <select class="custom-select" id="inputGroupSelect01 fornecedor" name="idfornecedor">
            <option selected hidden>Escolher...</option>
          </select>
        </div>
