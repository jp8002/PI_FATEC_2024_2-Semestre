...
<body>
    <div class="wrapper">
    <img src="PI2V2/App/Resources/imagens/dottext.png"  style="position: fixed; bottom: 0; left: 0; width: 100px; height: 40px;">
    <img src="PI2V2/App/Resources/imagens/loginicon.png"  width="90" height="65">
        <h2>CADASTRAR</h2>
        ...
        <form action="/cadastrarAl" method="post">
            ...
            <div class="form-group">
                <center>
                <input type="submit" class="blue-buttom" >
                </center>
                <span class="help-block"></span>

                <span class="help-block"></span>
                <!--<div class="form-group" style="background-color:blue">-->
            <a href="/PI2V2/" class="red-buttom">Realizar Login</a>
            <span class="help-block"></span>
            </div>
